...
(function (q, u, c) {
	...
	function d(a) {
		...
		function c(a, b, c, f) {
			k.stopCallback(b,
				b.target || b.srcElement, c, f) || !1 !== a(b, c) || (b.preventDefault ? b.preventDefault() : b.returnValue = !1, b.stopPropagation ?
		...
		k._handleKey = function (a,
			...
			for (h = 0; h < f.length; ++h) f[h].seq ? f[h].level == k && (l = !0, d[f[h].seq] = 1, c(f[h].callback, e, f[h].combo, f[h].seq)) : l ||
				c(f[h].callback, e, f[h].combo);
			f = "keypress" == e.type && r;
			e.type != x || w(a) || f || b(d);
			r = l && "keydown" == e.type
		};
...
(function (b) {
	var c = b.prototype.bind,
		a;
	b.prototype.bind = function () {
		a = arguments;
		if ("string" == typeof a[0] || a[0] instanceof Array) return c.call(this, a[0], a[1], a[2]);
		for (var b in a[0]) a[0].hasOwnProperty(b) && c.call(this, b, a[0][b], a[1])
	};
	b.init()
})(Mousetrap);

(function (a) {
	var b = a.prototype.stopCallback;
	a.prototype.stopCallback = function (a, c, d) {
